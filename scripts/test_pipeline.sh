...
#
# Usage:
#   ./scripts/test_pipeline.sh                     # 1.5B model, 20 samples
#   MODEL=qwen25_3b N=50 ./scripts/test_pipeline.sh
#
set -euo pipefail
...
OUT="runs/local_test/${MODEL}_${DATASET}"
BANKS="$OUT/banks.pt"
...
echo "  python scripts/inspect_results.py $TRAJ"
